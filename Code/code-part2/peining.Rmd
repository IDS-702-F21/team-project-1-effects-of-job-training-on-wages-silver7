...
final_model <- glm(wage ~ treat + age + educ + race + married + nodegree + 
    re74 + re75 + treat:re74 + treat:re75 + treat:race + treat:age + 
    race:re75 + race:married + race:nodegree + educ:race + age:nodegree, 
    family = binomial(), data = df)

no_race <- glm(wage ~ treat + age + educ + race + married + nodegree + 
    re74 + re75 + treat:re74 + treat:re75 + treat:age + 
    race:re75 + race:married + race:nodegree + educ:race + age:nodegree, 
    family = binomial(), data = df)
